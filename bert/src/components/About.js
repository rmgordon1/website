          ...
          <div className="col-lg-6 m-15px-tb">
            <div className="about-info">
              ...
              <div className="about-text">
                <h3>
                  {`I'm`} a DevOps Engineer with a passion for 3D modeling.{" "}
                </h3>
                <p>
                  {`I'm`} a DevOps Engineer with a passion for technology. Born and bred in New Jersey. I create creative infrastructure solutions to difficult problems. I like work with
                  new people that have different ideas and perspectives.
                </p>
                <div className="row">
                  <div className="col-auto">
                    <div className="media align-items-center">
                      {/* <span className="count">Also, I love Pokémon</span> */}
